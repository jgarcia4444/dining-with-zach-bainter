...
const Bio = () => {
    ...
    return (
        <div className="py-12 w-full bg-white rounded flex flex-row items-center justify-center">
            <div className="w-1/3 flex justify-center">
                <div className="bg-black rounded-full p-10 flex justify-center items-center">
                    <FiUser className="" color={"fff"} size={124} />
                </div>
            </div>
            <div className="w-2/3 flex flex-col">
                ...
                <div className="w-full">
                    ...
                    Hello and welcome to my website! My name is [insert your name], and I am a passionate chef, gardener, and farmer with over 20 years of experience in the culinary industry. As an excellent host, I love to bring people together over delicious food and create unforgettable dining experiences.<br /><br />
